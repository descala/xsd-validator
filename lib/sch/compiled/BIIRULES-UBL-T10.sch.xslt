...
<xsl:stylesheet xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2"
   ...
   <!--PATTERN UBL-T10-->
   <!--RULE -->
   <xsl:template match="/ubl:Invoice/cac:AllowanceCharge" priority="1008" mode="M7">
   ...
   <!--RULE -->
   <xsl:template match="//cac:InvoiceLine" priority="1006" mode="M7">
   ...
   <!--RULE -->
   <xsl:template match="//cac:InvoicePeriod" priority="1005" mode="M7">
   ...
   <!--RULE -->
   <xsl:template match="//cac:PaymentMeans" priority="1004" mode="M7">
   ...
   <!--RULE -->
   <xsl:template match="//cac:LegalMonetaryTotal" priority="1003" mode="M7">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
