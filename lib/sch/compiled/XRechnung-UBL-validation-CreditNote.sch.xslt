...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="Schematron Version 1.3.0 - XRechnung 1.2.2 compatible - UBL - CreditNote"
                              schemaVersion="">
         <xsl:comment>
   ...
   <!--SCHEMATRON PATTERNS-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schematron Version 1.3.0 - XRechnung 1.2.2 compatible - UBL - CreditNote</svrl:text>

   <!--PATTERN UBL-model-->


	  <!--RULE -->
   <xsl:template match="//ubl:CreditNote" priority="1007" mode="M7">
   ...
   <xsl:template match="//ubl:CreditNote/cac:Delivery/cac:DeliveryLocation/cac:Address"
	  ...
	  <!--RULE -->
   <xsl:template match="//ubl:CreditNote/cac:PaymentMeans" priority="1001" mode="M7">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
