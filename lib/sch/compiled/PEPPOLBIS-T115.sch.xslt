...
<xsl:stylesheet xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2"
   ...
   <!--RULE -->
   <xsl:template match="/ubl:OrderCancellation" priority="1118" mode="M19">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--RULE -->
   <xsl:template match="/ubl:OrderCancellation/cbc:ID" priority="1115" mode="M19">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--RULE -->
   <xsl:template match="/ubl:OrderCancellation/cbc:Note" priority="1112" mode="M19">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--RULE -->
   <xsl:template match="/ubl:OrderCancellation/*" priority="1000" mode="M19">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                        context="/ubl:OrderCancellation/*"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="cbc:ProfileID" priority="1001" mode="M20">
