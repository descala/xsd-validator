...
<!--
    ...
    Schematron Licensed under European Union Public Licence (EUPL) version 1.2
    Réalisé par Quentin Houard et Cyrille Sautereau pour le compte du FNFE-MPE.

-->
<!-- Schematron 20260216_BR-FR-Flux2-Schematron-CII_V1.3.0 - last update 2026 02 16 -->
...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
  ...
  <xsl:function name="custom:isSpecialContract" as="xs:boolean">
    ...
    <xsl:sequence select="
      ...
      or $context/rsm:ExchangedDocumentContext/ram:BusinessProcessSpecifiedDocumentContextParameter/ram:ID = 'B8'
  ...
  <pattern id="BR-FR-05">
    <title>BR-FR-05 — Présence obligatoire des mentions légales dans les notes (BG-1)</title>
  ...
  <pattern id="BR-FR-06">
    <title>BR-FR-06 — Unicité des codes sujets dans les notes (BG-1)</title>
  ...
  <pattern id="BR-FR-15">
    ...
    <!-- BT-151 --> <!-- CYS4 Correction pour autoriser absence de code sur lignes GROUP ou INFORMATION -->
  ...
  <pattern id="BR-FR-MV-03">     <!-- CYS' Règles revues -->
    ...
    <rule context="rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem[ram:AssociatedDocumentLineDocument/ram:LineStatusReasonCode = 'GROUP' and not(ram:AssociatedDocumentLineDocument/ram:ParentLineID)]">
      ...
      <!-- EXT-FR-FE-164 : Nom du vendeur -->
      <assert test="not(custom:isSpecialContract(/rsm:CrossIndustryInvoice)) or (normalize-space(./ram:SpecifiedLineTradeAgreement/ram:ItemSellerTradeParty/ram:Name) != '')"
        flag="fatal"
      ...
      <assert test="not(custom:isSpecialContract(/rsm:CrossIndustryInvoice)) or (normalize-space(./ram:SpecifiedLineTradeAgreement/ram:ItemSellerTradeParty/ram:SpecifiedLegalOrganization/ram:ID) != '')"
        flag="fatal"
      ...
      <assert test="not(custom:isSpecialContract(/rsm:CrossIndustryInvoice)) or (normalize-space(./ram:SpecifiedLineTradeAgreement/ram:ItemSellerTradeParty/ram:PostalTradeAddress/ram:CountryID) != '')"
        flag="fatal"
      ...
      <assert test="not(custom:isSpecialContract(/rsm:CrossIndustryInvoice)) or (normalize-space(./ram:SpecifiedLineTradeSettlement/ram:SpecifiedTradeSettlementLineMonetarySummation/ram:TaxTotalAmount[@currencyID = $invcurrency]) != '')"
        flag="fatal"
        id="BR-FR-MV-03_EXT-FR-FE-181">BR-FR-MV-03/EXT-FR-FE-181 :
        Ligne : <value-of select='./ram:AssociatedDocumentLineDocument/ram:LineID'/>, Valeur actuelle : "<value-of select='./ram:SpecifiedLineTradeSettlement/ram:SpecifiedTradeSettlementLineMonetarySummation/ram:TaxTotalAmount[@currencyID = $invcurrency]'/>".
        Pour une ligne GROUP sans parent, le montant total avec TVA (ram:TaxTotalAmount) doit être renseigné en devise de facture.
      </assert>

      <let name="acccurrency" value="../ram:ApplicableHeaderTradeSettlement/ram:TaxCurrencyCode"/>

      <assert test="not(custom:isSpecialContract(/rsm:CrossIndustryInvoice)) or not($acccurrency) or ($acccurrency != '' and normalize-space(./ram:SpecifiedLineTradeSettlement/ram:SpecifiedTradeSettlementLineMonetarySummation/ram:TaxTotalAmount[@currencyID = $acccurrency]) != '')"
        flag="fatal"
        id="BR-FR-MV-03_EXT-FR-FE-182"> BR-FR-MV-03/EXT-FR-FE-182 :
        Ligne : <value-of select='./ram:AssociatedDocumentLineDocument/ram:LineID'/>, Devise de comptabilité : "<value-of select='$acccurrency'/>", TVA en ligne : "<value-of select='./ram:SpecifiedLineTradeSettlement/ram:SpecifiedTradeSettlementLineMonetarySummation/ram:TaxTotalAmount[@currencyID = $acccurrency]'/>".
    ...
    <!-- BT-128 : Valeur d'objet facturé AFL - CYS4 corrigé car il peut y avoir plusieurs occurences de ram:AdditionalReferencedDocument -->
    <rule context="rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem[
      ...
      <assert test="not(custom:isSpecialContract(/rsm:CrossIndustryInvoice)) or ((./ram:TypeCode = '130') and (normalize-space(./ram:IssuerAssignedID) != ''))"
        flag="fatal"
        id="BR-FR-MV-03_BT-128_AFL">
        BR-FR-MV-03/BT-128 : Pour une ligne GROUP sans parent, une valeur d'objet facturé (ram:IssuerAssignedID) avec identifiant de schéma (ram:ReferenceTypeCode) = AFL doit être présente. Valeur actuelle : "<value-of select='./ram:IssuerAssignedID'/>".
      </assert>
    </rule>

    <!-- BT-128 : Valeur d'objet facturé AVV différente de M8/S8/B8 - CYS4 corrigé car il peut y avoir plusieurs occurences de ram:AdditionalReferencedDocument-->
    <rule context="rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem[
      ram:AssociatedDocumentLineDocument/ram:LineStatusReasonCode = 'GROUP'
      ...
      <assert test="not(custom:isSpecialContract(/rsm:CrossIndustryInvoice)) or ((./ram:TypeCode = '130') and (normalize-space(./ram:IssuerAssignedID) != '') and not(./ram:IssuerAssignedID = 'M8' or ./ram:IssuerAssignedID = 'S8' or ./ram:IssuerAssignedID = 'B8'))"
        flag="fatal"
        id="BR-FR-MV-03_BT-128_AVV">
        BR-FR-MV-03/BT-128 : Pour une ligne GROUP sans parent, une valeur d'objet facturé (BT-128 : ram:IssuerAssignedID) avec identifiant de schéma (BT-128-1 : ram:ReferenceTypeCode) = AVV doit être présente et différente de M8/S8/B8. Valeur actuelle : "<value-of select='ram:IssuerAssignedID'/>".
      </assert>
    </rule>

  </pattern>

  <pattern id="BR-FR-MV-05">
    <title>BR-FR-MV-05 — Vérification de la cohérence des totaux HT entre la ligne GROUP et ses lignes enfants</title>

    <rule context="rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem[
      ram:AssociatedDocumentLineDocument/ram:LineStatusReasonCode = 'GROUP'
      and not(ram:AssociatedDocumentLineDocument/ram:ParentLineID)]">

      <let name="grouplineID" value="normalize-space(./ram:AssociatedDocumentLineDocument/ram:LineID)"/>
      <let name="sumsubline" value="sum(../ram:IncludedSupplyChainTradeLineItem[ram:AssociatedDocumentLineDocument/ram:ParentLineID= $grouplineID and ram:AssociatedDocumentLineDocument/ram:LineStatusReasonCode != 'INFORMATION']
        /ram:SpecifiedLineTradeSettlement/ram:SpecifiedTradeSettlementLineMonetarySummation/ram:LineTotalAmount)"/>
      <let name="numberline" value="count(../ram:IncludedSupplyChainTradeLineItem[ram:AssociatedDocumentLineDocument/ram:ParentLineID= $grouplineID  and ram:AssociatedDocumentLineDocument/ram:LineStatusReasonCode != 'INFORMATION']
        /ram:SpecifiedLineTradeSettlement/ram:SpecifiedTradeSettlementLineMonetarySummation/ram:LineTotalAmount)"/>
  ...
  <pattern id="BR-FR-MV-06"> <!-- CYS4 revu -->
    ...
    <rule context="rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem">
      ...
      <let name="parentlineID" value="./ram:AssociatedDocumentLineDocument/ram:ParentLineID"/>
      <let name="legalID" value="normalize-space(./ram:SpecifiedLineTradeAgreement/ram:ItemSellerTradeParty/ram:SpecifiedLegalOrganization/ram:ID)"/>
      <let name="legalIDParent" value="normalize-space(../ram:IncludedSupplyChainTradeLineItem[ram:AssociatedDocumentLineDocument/ram:LineID = $parentlineID]/ram:SpecifiedLineTradeAgreement/ram:ItemSellerTradeParty/ram:SpecifiedLegalOrganization/ram:ID)"/>
  ...
  <pattern id="BR-FR-MV-07"> <!-- CYS4 revu -->
    ...
    <rule context="rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem">
      ...
      <let name="parentlineID" value="./ram:AssociatedDocumentLineDocument/ram:ParentLineID"/>
      <let name="numfact" value="normalize-space(./ram:SpecifiedLineTradeSettlement/ram:AdditionalReferencedDocument[(ram:ReferenceTypeCode = 'AFL') and (ram:TypeCode = '130')]/ram:IssuerAssignedID)"/>
      <let name="numfactparent" value="normalize-space(../ram:IncludedSupplyChainTradeLineItem[ram:AssociatedDocumentLineDocument/ram:LineID = $parentlineID]/ram:SpecifiedLineTradeSettlement/ram:AdditionalReferencedDocument[(ram:ReferenceTypeCode = 'AFL') and (ram:TypeCode = '130')]/ram:IssuerAssignedID)"/>
  ...
  <pattern id="BR-FR-MV-08"> <!-- CYS 4 - revue car  plusieurs BT-128 starts-with(., 'ABC') -->
    <title>BR-FR-MV-08 — Vérification de la raison d'exemption TVA contenant le numéro de sous-facture en ligne entre #</title>

    <rule context="rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem[ram:AssociatedDocumentLineDocument/ram:LineStatusReasonCode = 'DETAIL']">

      <let name="numfact" value="normalize-space(./ram:SpecifiedLineTradeSettlement/ram:AdditionalReferencedDocument[(ram:ReferenceTypeCode = 'AFL') and (ram:TypeCode = '130')]/ram:IssuerAssignedID)"/>

      <assert test="not(custom:isSpecialContract(/rsm:CrossIndustryInvoice))
        or (normalize-space(./ram:SpecifiedLineTradeSettlement/ram:ApplicableTradeTax/ram:ExemptionReason) != '' and $numfact != '' and starts-with(./ram:SpecifiedLineTradeSettlement/ram:ApplicableTradeTax/ram:ExemptionReason, concat('#', $numfact, '#')))"
        flag="fatal"
        id="BR-FR-MV-08_BT-128">
        BR-FR-MV-08/BT-128 : IDligne <value-of select='./ram:AssociatedDocumentLineDocument/ram:LineID'/>, Raison exemption : <value-of select='./ram:SpecifiedLineTradeSettlement/ram:ApplicableTradeTax/ram:ExemptionReason'/> / Num fact ligne: <value-of select= '$numfact'/>. Lorsque le cadre de facturation (BT-23) est S8, B8 ou M8, chaque ligne (BG-25) doit contenir une raison d'exemption TVA en texte commençant par le numéro de sous-facture en ligne entre #.
      </assert>
     </rule>
  </pattern>

  <pattern id="BR-FR-MV-09">
    <title>BR-FR-MV-09 — Vérification de la cohérence du montant total TVA pour une ligne GROUP avec la somme des ventilations TVA liées</title>
    ...
    <rule context="rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem[
      ...
      <let name="numfact" value="normalize-space(./ram:SpecifiedLineTradeSettlement/ram:AdditionalReferencedDocument[(ram:ReferenceTypeCode = 'AFL') and (ram:TypeCode = '130')]/ram:IssuerAssignedID)"/>
      <let name="sumvat" value="sum(../ram:ApplicableHeaderTradeSettlement/ram:ApplicableTradeTax[(ram:TypeCode = 'VAT') and starts-with(ram:ExemptionReason,concat('#',$numfact,'#'))]/ram:CalculatedAmount)"/>
      <let name="invcurrency" value="../ram:ApplicableHeaderTradeSettlement/ram:InvoiceCurrencyCode"/>
  ...
  <pattern id="BR-FR-MV-12">
    ...
    <rule context="rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction">
      <assert test="not(custom:isSpecialContract(/rsm:CrossIndustryInvoice))
        or not(ram:IncludedSupplyChainTradeLineItem[ram:AssociatedDocumentLineDocument/ram:LineStatusReasonCode = 'GROUP' and not(ram:AssociatedDocumentLineDocument/ram:ParentLineID)]
        /ram:SpecifiedLineTradeSettlement/ram:AdditionalReferencedDocument[(ram:ReferenceTypeCode = 'AFL') and (ram:TypeCode = '130')]
