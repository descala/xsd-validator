<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <pattern xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
      ...
      <let name="clOPStatusReason"
           value="tokenize('NON REF LEG REC QUA DEL PRI QTY ITM PAY UNR FIN PPD OTH', '\s')"/>
      <let name="clUNCL1001"
    ...
    <pattern>
	     ...
	     <rule context="cac:Status[cbc:StatusReasonCode='PPD']">
		       <assert id="PEPPOL-T111-R004" test="exists(cbc:StatusReason)" flag="fatal">If Clarification code is PPD, indicating partial payment, then Clarification reason SHALL be provided.</assert>
