RSpec.describe 'Schematron::XSLT2' do
  ...
  context '#execute_transform' do
    ...
    files.each do |file_path, xslt|
      # validate_stylesheet_file, not validate: the Factur-X stylesheets resolve their code lists against
      ...
      it "#{file_path} check validation_result format" do
        ...
        validation_result = Schematron::XSLT2.validate_stylesheet_file(File.expand_path("lib/sch/compiled/#{xslt}"), doc)
